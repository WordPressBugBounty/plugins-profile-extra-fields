...
= V1.3.7 - 08.09.2026 =
* Bugfix : Minor bugs fixes.

= V1.3.6 - 27.08.2026 =
* Update : All functionality was updated for WordPress 7.1.
* Bugfix : Bug were fixed when creating the field
...
= V1.3.4 - 07.04.2026 =
* Bugfix : Text area issue has been fixed.
